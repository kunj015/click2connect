...
const Footer = () => {
  return (
    <>
                <footer className=" text-rose-50 body-font bg-gray-800">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            ...
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                ...
                <span className="ml-3 text-xl text-gray-100">Click2Connect</span>
            </a>
            <p className="mt-2 text-sm text-gray-100">It is a unit of EpicLoin Pvt. Ltd.</p>
            </div>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <li>
                <Link href={"/joinform"} className="text-gray-100 hover:text-gray-400">
                    Join Form
                </Link>
                </li>
                <li>
